      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground">
            Our team is here to help you get the most out of Byte School. Choose the best way to reach out to us.
          </p>
        </div>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Textarea
                              placeholder="Tell us how we can help you with Byte School components..."
                              rows={10}
                              className="min-h-50"
                              {...field}
                            />
